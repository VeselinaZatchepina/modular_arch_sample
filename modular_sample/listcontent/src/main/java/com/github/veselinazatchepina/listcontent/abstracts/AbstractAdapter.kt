...
import com.github.veselinazatchepina.listcontent.extensions.inflate


/**
 * Реализация адаптера для использования в RecyclerView.
 *
 * @param items список элементов
 * @param layoutResId layout для элемента RecyclerView
 */
